...
!***********************************************************************
subroutine V_MLR_Xe_Xe(R, V, dVdR, d2VdR2)
  ! 
  !  Morse/Long-Range potential energy curve for Xe-Xe system.
  !  Raw data from:
  !    Hellmann, Jäger, and Bich
  ...
  !*********************************************************************
  ! Parameters...
  real(8), parameter   :: De = 194.51696D0, Re = 4.37815D0, Rref = 4.5D0
  integer, parameter   :: p = 6 , q = 3
  integer, parameter   :: N_C = 3 
  integer, parameter   :: m(N_C) = (/ 6, 8, 10 /)
  real(8), parameter   :: C(N_C) = &
    (/   1.39200000D+06,   1.38400000D+07,   1.99400000D+08 /)
  integer, parameter   :: beta_max = 4
  real(8), parameter   :: beta(0:beta_max) = &
    (/  -5.470000000000D-02 ,   -7.420000000000D-02 ,   -1.802200000000D-01 ,    1.690000000000D-01 ,    7.600000000000D-02 /)
  real(8), parameter   :: rho = 0.9D0, s=-0.5D0, bds=3.69D0, cds=0.405D0
  !*********************************************************************
