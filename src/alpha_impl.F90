...
SUBROUTINE ALPHA(T, MAXORD, MAXPQ, X, OMEGA11, OMEGA12, OMEGA22, MASS1, MASS2, D12, DT, LAMBDA)
  IMPLICIT NONE
  ...
  ! DOUBLE PRECISION :: D12(10), DT(10), LAMBDA(10)
  ...
  DOUBLE PRECISION, ALLOCATABLE :: GOMEGA (MAXORD,MAXORD,2,2)
  DOUBLE PRECISION :: HINT(0:MAXORD, 0:MAXORD, 2, 2, 2, 2)
  COMMON /ALPHAGASINFO/ MASS ! 2 IS THE TEMP SOLUTION, WHICH CAN BE CHANGED
  COMMON /ALPHAOMG/ GOMEGA, HINT
  INTEGER :: K
  ...
  IF(OLDT.NE.T) THEN ! Recalculate the integration when it's necessary
    write(22,*) "OM11"
    do i =1,6
      write(22,*) (GOMEGA(i, j, 1,1), j = 1,6)
    enddo
    write(22,*) "OM12"
    do i =1,6
      write(22,*) (GOMEGA(i, j, 1,2), j = 1,6)
    enddo
    write(22,*) "OM22"
    do i =1,6
      write(22,*) (GOMEGA(i, j, 2,2), j = 1,6)
    enddo
    DO IO2 = 1, 2
      DO IO1 = 1, 2
        DO I2 = 1, 2
