...
SUBROUTINE BETA(T, MAXORD, MAXPQ, X, OMEGA11, OMEGA12, OMEGA22, MASS1, MASS2, ETA)
  IMPLICIT NONE
  ...
  COMMON /BETAGASINFO/MASS ! 2 IS THE TEMP SOLUTION, WHICH CAN BE CHANGED
  COMMON /BETAOMG/ GOMEGA, LINT
  character(10) :: fmtstr
